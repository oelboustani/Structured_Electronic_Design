...
.. csv-table::
    ...
    Ca;  in N004; ; C; value; :math:`C_{a}`; :math:`C_{a}`
    V1;  N003 0; ; V; value; :math:`0`; :math:`0.0`
     ; ; ; ;dc; :math:`0`; :math:`0.0`
     ; ; ; ;dcvar; :math:`0`; :math:`0.0`
     ; ; ; ;noise; :math:`0`; :math:`0.0`
    E1;  N004 0 N003 0; ; E; value; :math:`L_{A}`; :math:`L_{A}`
    Cf;  in N001; ; C; value; :math:`C_{f}`; :math:`C_{f}`
...
.. csv-table::
    ...
    :math:`C_{a}` ; :math:`undefined` ; :math:`undefined`
    :math:`L_{A}` ; :math:`undefined` ; :math:`undefined`
    :math:`C_{f}` ; :math:`undefined` ; :math:`undefined`
